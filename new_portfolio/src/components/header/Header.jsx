  ...
  return (
   <header className='header'>
    <nav className='nav container'>
        <a href= "index.html" className='nav__logo'>Razal</a>
         ...
         "nav__menu"}>
            <ul className='nav__list grid'>
                ...
                <li className='nav__item'>
                    ...
                    "nav__link active-link" : "nav__link" }>
                    <i class="uil uil-brightness-minus nav__icon"></i>
                        Services
                    </a>
                </li>
                ...
                <li className='nav__item'>
                    <a href='#blog' onClick={() => setActiveNav ('#blog')} className= {activeNav === "#blog" ? 
                    "nav__link active-link" : "nav__link" }>
        ...
        <div className='nav__toggle' on onClick={() => showMenu
        (!Toggle)}>
